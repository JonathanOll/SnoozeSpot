...
class StoredFileService(private val storedFileRepository: StoredFileRepository) {
    ...
    suspend fun saveFile(inputFile: PartData.FileItem, description: String, type: StoredFileType, usage: StoredFileUsage): Result<StoredFileDTO> {
        ...
        return Result.success(fileResult.getOrThrow().toDTO())
    }
