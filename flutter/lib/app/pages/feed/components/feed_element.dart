...
class FeedElement extends StatefulWidget {
  ...
  const FeedElement({super.key, required this.post, required this.onDelete});
                ...
                Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        Navigator.of(context).pushNamed(
                          ...
                          arguments: _controller.post.user.uuid,
                        );
                      },
                      child: Row(
                        children: [
                          ...
                          Text(
                            _controller.post.user.username,
                    ...
                    DropdownButton<String>(
                      ...
                      onChanged: (op) {
                        if(op == "delete") {
                          _controller.deletePost(widget.onDelete);
                        }
                      },
